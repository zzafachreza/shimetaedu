...
$levels = $this->Levelmandarin_model->get_all_levels();
...
<div class="container-home">
    <div class="main-container">
        ...
        <div class="flex-main">
                <div class="flex-leftcontent">
                    ...
                    <?php foreach ($levels as $level): ?>
                                <a href="<?php echo site_url('bahasamandarin/level/' . $level->id); ?>" class="level">
        ...
        <div class="roadmap-container">
            <div class="roadmap">
                <img class="roadmap-img" src="assets/images/bahasamandarin_roadmap.png" alt="roadmap-bahasajepang">
            </div>
        </div>
